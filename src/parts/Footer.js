            ...
            <div className="row">
                ...
                <div className="col-auto mr-5">
                    ...
                    <ul className="list-group list-group-flush">
                        ...
                        <li className="list-group-item">
                            <Button type="link" href="/properties">Start New Booking</Button>
                        </li>
                        <li className="list-group-item">
                ...
                <div className="col-3">
                    ...
                    <ul className="list-group list-group-flush">
                        ...
                        <li className="list-group-item">
                            <Button isExternal type="link" href="tel:+62213123122">+62 2131 23122</Button>
                        </li>
                        <li className="list-group-item">
                            <span>Staycation, Kamang, Jakarta</span>
                        </li>
                    </ul>
                </div>
